...
class Scroller {
	...
	private boolean scrollScrollView(final ScrollView view, Direction direction) {
		...
		final int scrollAmount = (direction == Direction.DOWN) ?
				height : -height;
		...
		return (originalY == view.getScrollY()) ? false : true;
	}
	 ...
	 *            the direction in which to scroll
	 * @param allTheWay
	 *            <code>true</code> if the view should be scrolled to the
	 *            beginning or end, <code>false</code> to scroll one page up or
	 *            down.
	 * @return {@code true} if more scrolling can be done
	 * 
	 */
	 ...
	 *            the direction to be scrolled
	 * @param allTheWay
	 *            {@code true} to scroll the view all the way up or down,
	...
	public <T extends AbsListView> boolean scrollList(T absListView,
			Direction direction, boolean allTheWay) {
	 ...
	 * 
	 * @param view
	 *            the {@link AbsListView} to scroll
	 * @param line
